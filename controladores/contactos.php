...
class contactos
{
    ...
    public static function get($peticion)
    {
        ...
        else if($peticion[0] == 'agregado')
            return self::contacto_agregado();
        else
            return self::obtenerContactos($idUsuario, $peticion[0]);
    }

    private function contacto_agregado()
    {
        ...
        if(comprobar($correo))
        {
            ...
            return ["estado" => 1, "mensaje" => "El usuario si esta registrado"];
        }
        else
        {
            http_response_code(200);
            return ["estado" => 2, "mensaje" => "El usuario no esta registrado"];
        }
    }

    private function comprobar($correo)
    {
